...
async function main() {
  ...
  // Configuration
  const BRIDGE_ADDRESS = process.env.BRIDGE_ADDRESS || "0x0000000000000000000000000000000000000001"; // Replace with actual bridge
  const REMOTE_TOKEN = process.env.REMOTE_TOKEN || "0x0000000000000000000000000000000000000002"; // Replace with L1 tBTC
