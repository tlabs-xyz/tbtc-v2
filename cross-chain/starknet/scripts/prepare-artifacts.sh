...
help() {
  ...
  echo -e "\t--network: Ethereum network (mainnet or sepolia)."
...
ROOT_DIR="$(dirname "$0")/.."
SOURCE_DEPLOYMENT_DIR="$ROOT_DIR/deployments/$NETWORK"
DESTINATION_ARTIFACTS_DIR="$ROOT_DIR/artifacts"
...
cp -r $SOURCE_DEPLOYMENT_DIR $DESTINATION_ARTIFACTS_DIR
