...
contract BasicMintingPolicy is IMintingPolicy, AccessControl {
    ...
    function requestMint(
        ...
        address user,
        uint256 amount
    ) external override returns (bytes32 mintId) {
        // Validate inputs
        ...
        emit MintCompleted(mintId, qc, user, amount, msg.sender, block.timestamp);
    ...
    function isMintCompleted(bytes32 mintId) external view returns (bool completed) {
