...
contract LockReleaseTokenPoolUpgradeable is IPoolV1, ITypeAndVersion, Initializable, OwnableUpgradeable {
  ...
  string public constant override typeAndVersion = "LockReleaseTokenPoolUpgradeable 1.6.0";
  ...
  function lockOrBurn(
    ...
    s_token.safeTransferFrom(msg.sender, address(this), lockOrBurnIn.amount);
