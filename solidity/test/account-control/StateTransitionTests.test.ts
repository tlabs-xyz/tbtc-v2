...
describe("State Transition Tests", () => {
  ...
  beforeEach(async () => {
    ...
    ;[qcAddress, qcAddress2, watchdog1, watchdog2, watchdog3, watchdog4, watchdog5, user] = 
  ...
  describe("Proposal State Transitions", () => {
    ...
    it("should handle proposal cancellation", async () => {
      ...
      await watchdogConsensusManager.connect(watchdog1).cancelProposal(proposalId)
  ...
  describe("Watchdog State Transitions", () => {
    it("should handle watchdog activation and deactivation", async () => {
      ...
      await watchdogConsensusManager.connect(governance).deactivateWatchdog(newWatchdog.address)
