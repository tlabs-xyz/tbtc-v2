...
/**
 * SPV data creation and management utilities
 * Handles creation of Bitcoin transaction and proof data for testing
 */
...
export function createRealSpvData(): {
  ...
  return {
    ...
    chainDifficulty: ValidMainnetProof.chainDifficulty || TEST_CONSTANTS.DEFAULT_CHAIN_DIFFICULTY,
  }
}
...
export async function setupMockRelayForSpv(
  ...
  const difficulty = chainDifficulty || TEST_CONSTANTS.DEFAULT_CHAIN_DIFFICULTY
...
export function createMockSpvValidationResult(isValid = true): {
  ...
  return {
    ...
    blockHeight: TEST_CONSTANTS.DEFAULT_BLOCK_HEIGHT,
    confirmations: TEST_CONSTANTS.DEFAULT_CONFIRMATIONS,
  }
}
