...
export const STARKNET_ERROR_MESSAGES = {
  ...
  ADDRESS_EXCEEDS_FIELD_SIZE: "StarkNet address exceeds maximum field element size"
}
...
export function createMockDeposit(): any {
  return {
    depositor: { identifierHex: "0x742d35Cc6634C0532925a3b844Bc9e7595f7FACE" } as any,
